...
<div class="container" style="margin-left: 12rem">
    ...
    <div class="mb-2">
        ...
        /
        <a href="" style="text-decoration: none;">Detail Klasifikasi Surat</a>
    </div>
    ...
    <div class="container mt-5">
        ...
        <div class="d-flex">
            ...
            <div class="card p-3 d-block" style="width: 500px; margin-right: 1rem">  
                    ...
                    <a href="{{ route('letter.letters.download-pdf', $letters['id']) }}" style="float: right;margin-top: -2rem; font-size:15px;">download.pdf</a>
                    <div class="p-3">
