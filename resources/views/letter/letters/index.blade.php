...
<div class="container" style="margin-left: 12rem">
    ...
    <h3 class="mb-2">Data Surat</h3>
    <div class="mb-2">
        <a href="/dashboard" style="text-decoration: none;">Home</a>
        /
        <a href="" style="text-decoration: none;">Data Surat</a>
    </div>
...
<div class="container bg-light p-5">
    ...
    @endif
        ...
        <a href="{{ route('letter.letters.download-excel') }}" class="btn btn-info text-white">Eksport</a>
       ...
       <table class="table mt-3 table-striped table-bordered table-hovered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <a href="{{ route('letter.letters.show', $item['id']) }}" class="btn btn-info text-white" style="margin-right: 5px;">Lihat</a>
